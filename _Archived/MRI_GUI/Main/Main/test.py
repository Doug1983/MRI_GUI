...
if __name__ == "__main__":
    ...
    sys.exit(app.exec_())
     ...
     #scan the selected directory
            allDirs = []
            allDICOM = defaultdict(list) #dictionary containing file name and number of files: {'file': [Nbr, maxNbr]}
            logFile = ''

           
            
            #Send qt signal
            self.fileLoaded.emit(self.logFile, self.allDICOM, self.allDirs)